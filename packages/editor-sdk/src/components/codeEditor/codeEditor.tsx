...
function CodeEditorCommon(
  ...
  const { editor, children, disabled, onClick, ...editorProps } = props;
  const { view ,isFocus} = useCodeMirror(editorProps, editor);
  console.log('child', editor, children);
  return (
    <CodeEditorWrapper
      onClick={() => {
        // onClick ? (e) => view && onClick(e, view) : undefined
      }}
    >
...
export function CodeEditor(props: CodeEditorProps) {
  ...
  return (
    <CodeEditorCommon {...editorProps} editor={editor} disabled={false}>
      <Container
        styleName={props.styleName}
